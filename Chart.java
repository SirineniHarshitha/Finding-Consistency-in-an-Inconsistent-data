...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(Detection.mysql_time,"Mysql Query Execution Time","Mysql Query Execution Time");
	localDefaultCategoryDataset.addValue(Detection.onescan_time,"Big Query Execution Time","Big Query Execution Time");
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Technique Name", "Query Execution Time (Milli.Sec)", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
